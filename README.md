...
3) Build the image in local -> docker build -t Kailashcp/shopfront:latest .

docker build -t praveensingam1994/productcatalogue:latest .

docker build -t praveensingam1994/stockmanager:latest .

4) Push the image to your docker hub -> docker push Kailashcp/shopfront:latest 

docker push Kailashcp/productcatalogue:latest

docker push Kailashcp/stockmanager:latest
